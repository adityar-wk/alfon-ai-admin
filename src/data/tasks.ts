...
const SEED: Task[] = [
  ...
  T(3, "Late Checkout Request", "Olivia Brown", "1203", "Front Desk", "Sarah K.", "Medium", { kind: "left", text: "22 min left" }, "Yet to Assign", "Guest Chat"),
  T(4, "Minibar Restock", "Noah Martinez", "1802", "Room Service", "Anna P.", "Medium", { kind: "left", text: "35 min left" }, "Yet to Assign", "Staff"),
  T(5, "Extra Towels", "Isabella Rossi", "2104", "Housekeeping", null, "Low", { kind: "due", text: "Due in 28 min" }, "Yet to Assign", "Guest Chat"),
  ...
  T(8, "Room Move Request", "William Taylor", "1107", "Front Desk", "Sarah K.", "Medium", { kind: "met", text: "On time" }, "Yet to Assign", "PMS"),
  T(9, "Wake-up Call Setup", "Ava Thompson", "2501", "Front Desk", "Maria S.", "Low", { kind: "met", text: "On time" }, "Yet to Assign", "Guest Chat"),
  T(10, "Newspaper Delivery", "Daniel Kim", "1305", "Room Service", null, "Low", { kind: "due", text: "Due in 18 min" }, "Yet to Assign", "Staff"),
  T(11, "Iron & Ironing Board", "Sophia Lee", "1904", "Housekeeping", "Maria S.", "Low", { kind: "met", text: "On time" }, "Yet to Assign", "Guest Chat"),
  T(12, "Arabic-Speaking Meet & Greet", "Khalid Al-Mansouri", "1710", "Concierge", "John S.", "High", { kind: "due", text: "Due in 12 min" }, "Yet to Assign", "Staff", { vip: true }),
  ...
  T(17, "Extra Pillows", "Ananya Kapoor", "908", "Housekeeping", "Lisa M.", "Low", { kind: "due", text: "Due in 15 min" }, "Yet to Assign", "Guest Chat"),
  T(18, "Baby Cot Setup", "Sarah Chen", "704", "Housekeeping", null, "Medium", { kind: "due", text: "Due in 22 min" }, "Yet to Assign", "Guest Chat"),
  ...
  T(24, "Extra Blanket", "Pooja Patel", "602", "Housekeeping", null, "Low", { kind: "due", text: "Due in 20 min" }, "Yet to Assign", "Guest Chat"),
  T(25, "Mattress Topper Request", "Robert Brown", "905", "Housekeeping", "Maria S.", "Medium", { kind: "left", text: "50 min left" }, "Yet to Assign", "PMS"),
  ...
  T(29, "Pillow Menu Selection", "Emma Davis", "1608", "Housekeeping", null, "Medium", { kind: "due", text: "Due in 12 min" }, "Yet to Assign", "Guest Chat"),
  T(30, "Airport Transfer Booking", "Robert Brown", "905", "Concierge", "John S.", "Medium", { kind: "left", text: "45 min left" }, "Yet to Assign", "Guest Chat"),
  ...
  T(33, "Invoice Copy Request", "David Williams", "1008", "Front Desk", null, "Low", { kind: "due", text: "Due in 25 min" }, "Yet to Assign", "Guest Chat"),
  ...
  T(36, "Spa Appointment Change", "Emma Davis", "1608", "Guest Services", "Priya N.", "Medium", { kind: "left", text: "1 hr left" }, "Yet to Assign", "Guest Chat"),
  T(37, "Extra Hangers", "Liam Anderson", "623", "Housekeeping", null, "Low", { kind: "left", text: "55 min left" }, "Yet to Assign", "Guest Chat"),
  T(38, "Bathrobe Replacement", "Olivia Turner", "1108", "Housekeeping", null, "Medium", { kind: "left", text: "40 min left" }, "Yet to Assign", "Staff"),
