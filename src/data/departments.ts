...
export const DEPARTMENTS: Department[] = [
  {
    ...
    services: [
      ...
      { name: "Luggage Storage", active: true },
      { name: "Late Check-out Request", active: true },
      { name: "Wake-up Call", active: true },
      { name: "Lost & Found Enquiry", active: true },
      { name: "Invoice & Billing Query", active: true },
    ],
  },
  {
    slug: "guest-services",
    ...
    services: [
      ...
      { name: "Event & Tour Booking", active: true },
      { name: "Guest Feedback Follow-up", active: true },
      { name: "Amenity Requests", active: true },
    ],
  },
  {
    slug: "concierge",
    ...
    services: [
      ...
      { name: "Special Occasion Setup", active: true },
      { name: "Restaurant Reservation", active: true },
      { name: "Airport Transfer", active: true },
      { name: "Taxi & Car Hire", active: true },
      { name: "Tickets & Attractions", active: true },
      { name: "Spa Booking", active: true },
    ],
  },
  {
    ...
    services: [
      ...
      { name: "Private Dining", active: true },
      { name: "Breakfast Boxes", active: true },
      { name: "Bar Service", active: true },
      { name: "Kids Menu Requests", active: true },
    ],
  },
  {
    slug: "housekeeping",
    ...
    services: [
      ...
      { name: "Extra Towels & Linen", active: true },
      { name: "Turndown Service", active: true },
      { name: "Deep Cleaning", active: true },
      { name: "Amenity Restocking", active: true },
      { name: "Rollaway Bed Setup", active: true },
      { name: "Minibar Check", active: true },
    ],
  },
  {
    slug: "laundry",
    ...
    services: [
      ...
      { name: "Express Laundry", active: true },
      { name: "Dry Cleaning", active: true },
      { name: "Ironing & Pressing", active: true },
      { name: "Stain Treatment", active: true },
      { name: "Laundry Pickup", active: true },
    ],
  },
  {
    slug: "engineering",
    ...
    services: [
      ...
      { name: "AC & Heating Repair", active: true },
      { name: "Plumbing Issues", active: true },
      { name: "Electrical Faults", active: true },
      { name: "Lift Breakdown", active: true },
      { name: "TV & Remote Issues", active: true },
      { name: "Furniture Repair", active: true },
    ],
  },
  {
    slug: "room-service",
    ...
    services: [
      ...
      { name: "In-Room Dining Order", active: true },
      { name: "Tray Collection", active: true },
      { name: "Special Occasion Delivery", active: true },
      { name: "Late-Night Menu", active: true },
    ],
  },
  {
    ...
    services: [
      ...
      { name: "Lost Property Report", active: true },
      { name: "Room Access Request", active: true },
      { name: "Incident Report", active: true },
      { name: "CCTV Review Request", active: true },
    ],
  },
  {
    slug: "it",
    ...
    services: [
      ...
      { name: "Wi-Fi Support", active: true },
      { name: "Smart TV & Casting", active: true },
      { name: "Printing Request", active: true },
      { name: "Device Charging & Adapters", active: true },
    ],
  },
  {
    slug: "operator",
    ...
    services: [
      ...
      { name: "Call Transfers", active: true },
      { name: "Wake-up Call Scheduling", active: true },
      { name: "Message Taking", active: true },
      { name: "Outside Line Requests", active: true },
    ],
  },
  {
    slug: "reservations",
    ...
    services: [
      ...
      { name: "Booking Modification", active: true },
      { name: "Cancellation Request", active: true },
      { name: "Group Booking", active: true },
      { name: "Rate & Package Enquiry", active: true },
      { name: "Loyalty Points Query", active: true },
    ],
  },
];
